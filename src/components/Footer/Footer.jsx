    ...
    <footer className="bg-white border-y w-full shadow fixed z-50 bottom-0">
      <div className="mx-auto w-full max-w-screen-xl py-5">
        <div className="sm:flex sm:items-center sm:justify-between">
          ...
          <div className="flex space-x-5 sm:justify-center items-center sm:mt-0">
            <Link
              to="https://github.com/surajverma02"
            ...
            <Link
              to="https://www.facebook.com/profile.php?id=100026799344241&mibextid=ZbWKwL"
